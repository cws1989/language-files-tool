...
public class Charset {
    ...
    protected static Map<String, String> charsetCodeToDisplayName = new TreeMap<String, String>();
    protected static List<CharsetEntry> charsetDisplayNameToCode = new ArrayList<CharsetEntry>();
    ...
    static {
        ...
        for (int i = 0, iEnd = c; i < iEnd; i++) {
            String key = set[i][0], value = set[i][1];
            charsetCodeToDisplayName.put(key.toLowerCase(), value);
        }
    ...
    public static class CharsetEntry implements Comparable<Object> {
